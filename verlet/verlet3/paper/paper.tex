...
% Enter abstract:
The ``Volcity Verlet'' algorithm is implemented in order to predict the location of three
...
The
literature\footnote{https://pythoninchemistry.org/ch40208/molecular_dynamics/choosing_the_right_timestep.html}
