...
!  do i = 2, steps, 1
!    ! \alpha_{k+1}
!    x(1,1) = x(1,1) + tau*v(1,1) + tau**2 * f(1,1) / (2*mass)
!    x(1,2) = x(1,2) + tau*v(1,2) + tau**2 * f(1,2) / (2*mass)
!    x(1,3) = x(1,3) + tau*v(1,3) + tau**2 * f(1,3) / (2*mass)
!    ! particle b
!    x(2,1) = x(2,1) + tau*v(2,1) + tau**2 * f(2,1) / (2*mass)
!    x(2,2) = x(2,2) + tau*v(2,2) + tau**2 * f(2,2) / (2*mass)
!    x(2,3) = x(2,3) + tau*v(2,3) + tau**2 * f(2,3) / (2*mass)
...
!
!    ! v_{k+1}
!    v(1,1) = v(1,1) + tau/2*mass * (f(1,1) + fnext(1,1) )
!    v(1,2) = v(1,2) + tau/2*mass * (f(1,2) + fnext(1,2) )
!    v(1,3) = v(1,3) + tau/2*mass * (f(1,3) + fnext(1,3) )
!    v(2,1) = v(2,1) + tau/2*mass * (f(2,1) + fnext(2,1) )
!    v(2,2) = v(2,2) + tau/2*mass * (f(2,2) + fnext(2,2) )
!    v(2,3) = v(2,3) + tau/2*mass * (f(2,3) + fnext(2,3) )
!
!    f(1,1) = fnext(1,1)
!    f(1,2) = fnext(1,2)
!    f(1,3) = fnext(1,3)
